...
class Repository(private val context:Context) {
 ...
 suspend fun stateBundles()=api.stateBundles()
 suspend fun latestStateBundle()=api.latestStateBundle()
 suspend fun verifyLatestStateBundle()=api.verifyLatestStateBundle()
 suspend fun lastEmergencyStateBundle()=api.lastEmergencyStateBundle()
 suspend fun verifyLastEmergencyStateBundle()=api.verifyLastEmergencyStateBundle()
 suspend fun importVerifiedStateBundle(id:String)=api.importVerifiedStateBundle(id)
 ...
 suspend fun emergencyStop(reason:String="Emergency stop from Android", exportBundle:Boolean=true)=api.emergencyStop(reason, exportBundle)
 suspend fun emergencyResume()=api.emergencyResume()
 suspend fun emergencyStatus()=api.emergencyStatus()
}
